...
console.log("im here");
function init() {
    var myModal = new (0, _bootstrap.Modal)(document.getElementById("exampleModal"));
    renderTodos();
    ...
    document.getElementById("container").addEventListener("click", (e)=>{
        ...
        if (el.classList.contains("remove-todo")) {
            ...
            (0, _apiDefault.default).removeById(liEl.id);
            renderTodos();
        }
    }, {
        capture: true
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["7Aums","bNKaB"], "bNKaB", "parcelRequire28c1")
